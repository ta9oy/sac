...
import DefaultLayout from '@/views/login/UserLogin.vue'
...
//   {
//     path: '/',
//     redirect: '/user-login' // Change default redirection to login without forcing a layout
//   },
//   {
//     path: '/user-login',
//     name: 'UserLogin',
...
const routes = [
  {
    ...
    redirect: '/user-login', // Default redirection to login page
    children: [
      {
        path: '/dashboard',
        name: 'Dashboard',
      ...
      },
      {
        path: '/visitors/entry',
        name: 'Visitors Entry',
        component: () => import( '@/views/visitors/VisitorsEntry.vue'),
      },
      {
        path: '/visitors/visitDetails',
        name: 'Visit Details',
        component: () => import( '@/views/visitors/VisitDetails.vue'),
      },
      {
        path: '/users',
        name: 'Users',
